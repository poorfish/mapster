// Theme configurations ported from original maptoposter JSON files
export const themes = {
    feature_based: {
    ...
    noir: {
        ...
        water: "#0A0A0A",
        parks: "#111111",
        rail: "#999999", // Maximized visibility (Light Gray)
    ...
    midnight_blue: {
        ...
        water: "#061020",
        parks: "#0F2235",
        rail: "#9E8040", // Maximized visibility (Bright Gold/Bronze)
    ...
    neon_cyberpunk: {
        ...
        water: "#0A0A15",
        parks: "#151525",
        rail: "#D900D9", // Maximized visibility (Bright Neon Purple)
    ...
    blueprint: {
        ...
        water: "#0F2840",
        parks: "#1E4570",
        rail: "#6AB0D0", // Maximized visibility (Bright Cyan Blue)
    ...
    emerald: {
        ...
        water: "#0D4536",
        parks: "#0F523E",
        rail: "#42B088", // Maximized visibility (Bright Mint Green)
